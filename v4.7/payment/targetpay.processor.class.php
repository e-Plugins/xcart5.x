...
class targetpay_processor
{
    ...
    private static function format_phone($country, $phone) {
        ...
        if(method_exists('targetpay_processor', $function)) {
    ...
    public function handleRequest($salt = "")
    {
        ...
        else
        {
            ...
            $digiCore->setReturnUrl($current_location . "/payment/cc_targetpay_$this->target_processor_file_name.php?return=success");
            $digiCore->setCancelUrl($current_location . "/payment/cc_targetpay_$this->target_processor_file_name.php?return=cancel");
            $digiCore->setReportUrl($current_location . "/payment/cc_targetpay_$this->target_processor_file_name.php?return=callback");
