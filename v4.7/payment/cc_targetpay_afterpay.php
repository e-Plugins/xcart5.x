...
*/
require_once 'targetpay.processor.class.php';
require_once 'targetpay.validation.exception.class.php';

$result = (new targetpay_processor("afterpay", "AFP", "Digiwallet - Afterpay"))->handleRequest();
