...
$check_language = "SELECT * FROM $sql_tbl[languages] WHERE code = 'en' and name = 'digiwallet_bankwire_success_text' limit 1";
if(db_num_rows(db_query($check_language)) != 1){
    db_query("INSERT INTO $sql_tbl[languages] VALUES ('en','digiwallet_bankwire_success_text',' ". addslashes($success_text_en) . "','Text')");
}
$check_language = "SELECT * FROM $sql_tbl[languages] WHERE code = 'nl' and name = 'digiwallet_bankwire_success_text' limit 1";
if(db_num_rows(db_query($check_language)) != 1){
    db_query("INSERT INTO $sql_tbl[languages] VALUES ('nl','digiwallet_bankwire_success_text',' ". addslashes($success_text_nl) . "','Text')");
}
