...
class ClientCore
{
     ...
     * @param $apiKey
     * @param $data
     * @return bool|\Digiwallet\Packages\Transaction\Client\Response\CreateTransaction
    ...
    protected function clientStartTransaction($apiKey, $params)
    {
        ...
        $digiwalletApi = new \XLite\Module\Digiwallet\Payment\client\src\Client(self::DIGIWALLET_API_URL);
        $request = new \XLite\Module\Digiwallet\Payment\client\src\Request\CreateTransaction($digiwalletApi, $params);
    ...
    {
        $digiwalletApi = new \XLite\Module\Digiwallet\Payment\client\src\Client(self::DIGIWALLET_API_URL);
        $request = new \XLite\Module\Digiwallet\Payment\client\src\Request\CheckTransaction($digiwalletApi);
        $request->withBearer($apiKey);
